...
//Left Motors:
motor_group(leftMotorA, leftMotorB, leftMotorC, leftMotorD),

//Right Motors:
motor_group(rightMotorA, rightMotorB, rightMotorC, rightMotorD),
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    other.setVelocity(35, percent);
    other.setStopping(brake);
    bool pnu = false;
